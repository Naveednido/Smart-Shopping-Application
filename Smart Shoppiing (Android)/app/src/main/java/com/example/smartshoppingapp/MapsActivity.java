...
import com.example.smartshoppingapp.MapsClasses.GetNearByPlacesData;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RippleBackground rippleBg = findViewById(R.id.ripple_bg);
        ...
        Places.initialize(MapsActivity.this, getString(R.string.google_maps_apii));
                ...
                if (!materialSearchBar.getText().isEmpty()) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            url = getUrl(mLastKnownLocation.getLatitude(), mLastKnownLocation.getLongitude(), materialSearchBar.getText());
                            dataTransfer[0] = mMap;
                            dataTransfer[1] = url;
    ...
    private String getUrl(double lat , double lng , String nearbyPlaces)
    {
        ...
        String url= "https://maps.googleapis.com/maps/api/place/textsearch/json?query="+nearbyPlaces+"&location="+lat+","+lng+"&radius="+PROXIMATY_RADIUS+"&key=AIzaSyBIxI5sG15Ap78sXpCdP06L0yS1FhmRHJw";
        return url;
    }
